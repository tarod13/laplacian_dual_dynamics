...
parallel -j4 apptainer exec --nv -B /home -B $PWD:/pwd -B /project -B /scratch -B /localscratch -B /project/def-mbowling/diegog/laplacian_dual_dynamics/ --pwd /pwd ~/apptainer/jax_cuda11.8.sif python train_laprepr.py --save_dir ~/logs/laplacian_dual_dynamics/ --config_file coefficient_augmented_martin.yaml --env_name {3} --seed {1} --regularization_weight {2} :::: ./rl_lap/hyperparam/seed_list_minimal_1-30.txt ::: 0.04 ::: GridRoom-64
