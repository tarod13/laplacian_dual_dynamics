...
apptainer exec --nv -B /home -B $PWD:/pwd -B /project -W /scratch -B /localscratch -B $PROJECT_FOLDER --pwd /pwd ~/apptainer/lk_haiku_n.sif python3 train_laprepr.py "EXP1-PIXELS-MULTI" --use_wandb --config_file $CONFIG --obs_mode "both" --env_name $ENV --seed $SEED --barrier_initial_val $B --lr_barrier_coefs $LR --n_samples 3000000 --total_train_steps 400000