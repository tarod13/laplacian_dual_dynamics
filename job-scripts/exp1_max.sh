...
envs=("GridRoom-64" "GridRoom-4" "GridRoomSym-4" "GridMaze-7" "GridMaze-17" "GridMaze-9" "GridMaze-32" "GridMaze-26" "GridRoom-32")
bs=(20.0 10.0 5.0 2.0 1.0 0.5 0.2 0.1 0.05 0.02 0.01)
lrs=(0.0 0.001 0.01 0.1 1.0)
configs=("cqp.yaml" "sqp.yaml" "al.yaml")

N_SEED=$((${SLURM_ARRAY_TASK_ID} / 1485 + 1))
R_ENV=$((${SLURM_ARRAY_TASK_ID} % 1485))
N_ENV=$((${R_ENV} / 165))
R_B=$((${R_ENV} % 165))
N_B=$((${R_B} / 15))
R_LR=$((${R_B} % 15))
